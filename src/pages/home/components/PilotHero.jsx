...
export default function PilotHero() {
  ...
  return (
    <section className="w-full min-h-screen bg-gray-100 flex items-center justify-center px-4 sm:px-6 pt-28 pb-16 md:py-0">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
        ...
        <div className="space-y-6 text-center md:text-left order-2 md:order-1">
          <h1 className="text-[2.5rem] sm:text-5xl md:text-6xl font-bold leading-tight text-gray-900">
            ...
            <span className="text-blue-600">Commercial Pilot</span> <br className="hidden md:block" />
          ...
          <p className="text-gray-500 text-base sm:text-lg leading-relaxed max-w-md mx-auto md:mx-0">
            Commercial Pilot Training in India &amp; Abroad <br className="hidden md:inline" />
            Integrated Pilot Mentorship Program <br className="hidden md:inline" />
            Flying Training in USA, New Zealand, Spain &amp; Greece <br className="hidden md:inline" />
